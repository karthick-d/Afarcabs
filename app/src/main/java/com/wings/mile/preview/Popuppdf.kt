...
class Popuppdf(private var activity: FragmentActivity?, fileurl: String) : BaseObservable() {
    ...
    fun showFullImageView() {
        if (fileurl!!.isNotEmpty()) {
            ...
            val defectImageviewBinding: PdfViewBinding = DataBindingUtil.inflate(
...
//                        .into(defectImageviewBinding.fullimageview)
            defectImageviewBinding.idPDFView!!.settings.javaScriptEnabled = true
            defectImageviewBinding.idPDFView!!.getSettings().setPluginState(WebSettings.PluginState.ON);
            defectImageviewBinding.idPDFView!!.loadUrl("https://docs.google.com/gview?embedded=true&url=$fileurl")

            defectImageviewBinding.pdfViewModels  = this

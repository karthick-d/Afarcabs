package com.wings.mile.location;
...
import com.wings.mile.Customer.CustomerMapActivity;
import com.wings.mile.R;
import com.wings.mile.location.utils.SimplePlacePicker;
import com.wings.mile.location.utils.CustomButton;
import com.wings.mile.location.utils.CustomTextView;
import com.wings.mile.location.utils.FetchAddressIntentService;
...
public class MapActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    //receiving
    private String mApiKey = "AIzaSyB4P__PDmWwlnyfUysMj3Ah9KBWIz1uS1w" ;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_maps_pickeer);
    ...
    private void submitResultLocation(){
        ...
        if (addressResultCode == SimplePlacePicker.FAILURE_RESULT || !isSupportedArea) {
            Toast.makeText(MapActivity.this, "Failed select", Toast.LENGTH_SHORT).show();
        } else {
    ...
    private void updateUi() {
        ...
        if (addressResultCode == SimplePlacePicker.SUCCESS_RESULT) {
            ...
            if (isSupportedArea(mSupportedArea)) {
                ...
                mDisplayAddressTextView.setText("not supported");
            }
        ...
        if (ContextCompat.checkSelfPermission(this, android.Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ContextCompat.checkSelfPermission(this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, android.Manifest.permission.ACCESS_FINE_LOCATION) &&
                ...
                new android.app.AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("OK", (dialogInterface, i) -> ActivityCompat.requestPermissions(MapActivity.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION}, 1))
                        .create()
                        .show();
            } else {
                ActivityCompat.requestPermissions(MapActivity.this, new String[]{android.Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION, Manifest.permission.CALL_PHONE}, 1);
            }
        }
    }
}
